...
/** @override */
  ...
  async insertFile(file, fields = { "createdBy" : "607e854a16605027fc03b7c9"}) {
    ...
    {
      path: 'C:\\xampp\\htdocs\\Adapt-Server-Refactor\\adapt-authoring\\tmp\\tmpassets\\sample_photo.jpg',
      type: 'image/jpeg'
    },
    {
      path: 'C:\\xampp\\htdocs\\Adapt-Server-Refactor\\adapt-authoring\\tmp\\tmpassets\\sample_video.mp4',
      type: 'video/mp4'
    },
    {
      path: 'C:\\xampp\\htdocs\\Adapt-Server-Refactor\\adapt-authoring\\tmp\\tmpassets\\sample_zip.zip',
      type: 'application/zip'
    }];
     const result = insertfiles.bind(this)(files, fields);
